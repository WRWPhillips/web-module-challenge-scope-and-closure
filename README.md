...
1. In your own words, define closure (1-2 sentences).
  Closure is the way a function reaches out to a parent function for data, it's a function in its lexical context
...
a. Where is closure used in this code? How can you tell?
  the function being returned references newRoll? I am not totally sure
b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?
  the name and template literal logged will always be the same, but the random number generated by newRoll can be different
